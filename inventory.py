...
def add_new():
    ...
    if id not in data.keys():
        ...
        print("Please Press '0' to Add New\Attributes/Properties of Product or Press '1' to Continue: - ")
...
def update_prod_data():
    ...
    print("Enter The Product ID of The Product\ Which You Want To Update: - ")

    temp = input()

    if temp in data.keys():

        print("Want to update whole product data\ press '0' else '1' for specific data: - ")
